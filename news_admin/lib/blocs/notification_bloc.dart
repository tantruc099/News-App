...
//Lớp NotificationBloc quản lý trạng thái thông báo và tương tác với Firestore.
// sendNotification gửi thông báo qua Firebase Cloud Messaging.
// saveToDatabase lưu thông báo vào Firestore.

// getNotificationsList, addToNotificationList, removeFromNotificationList,
// deleteCustomNotification, getContentNotificationsList quản lý danh sách thông báo trong Firestore.

// notifyListeners được gọi sau mỗi thay đổi dữ liệu để thông báo cho các widget lắng nghe về sự thay đổi
